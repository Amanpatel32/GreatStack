  ...
  return (
    ...
    <tr className='order-y border-gray-300'>
        <td className='px-6 py-4'>
            ...
            <br/>
            <br/>
            <b className='font-medium text-gray-600'>Name</b> : {comment.content}
            <br/>
        ...
        <td className='px-6 py-4'>
            <div className='inline-flex items-center gap-4'>
                {!comment.isApproved ? <img
                onClick={approveComment} src={assets.tick_icon} className='w-5 hover:scale-110 transition-all cursor-pointer'/>
                 :
