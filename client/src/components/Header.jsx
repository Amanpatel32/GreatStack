  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
        ...
        <div className='inline-flex itens-center justify-center gap-4 px-6 py-1.5 mb-4 border-primary/40 bg-primary/10 rounded-full text-sm text-primary'>
            <p>New: AI feature intergrated</p>
            <img src={assets.star_icon} className='w-2.5' alt='' />
        </div>

          <h1 className='text-3xl sm:text-6xl font-semibold smLleading-16 text-gray-700'>Your own<span className='text-primary'> blogging </span><br/> platform.</h1>
           <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500'>This is your space to think out loud, to share what matters amd to write without filters.Weteher it's one word or thousand,your story start right here</p>
