    ...
    <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll'>
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
        ...
        <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
          ...
          <button className='absolute bottom-1 right-2 ml-2 text-white bg-black/70 px-4 py=1.5 rounded hover:underline cursor-pointer' type='button' onClick={generateContent} disabled={loading}>Generate With AI</button>
        </div>
        <p className='mt-4'>Blog category</p>
         <select className='mt-2 px-3 py-2 border text-gray-500 border-gray-300 outline-none rounded' onChange={e=>setCategory(e.target.value)} name='category'>
